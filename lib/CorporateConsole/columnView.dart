                                                              ...
                                                              child: expandWork
                                                                  ? Column(
                                                                      children: [
                                                                        ...
                                                                        ListTile(
                                                                            leading:
                                                                                CircleAvatar(backgroundColor: Colors.deepPurple.shade200),
                                                                            title: Text(
                                                                              'Job Description',
                                                                              style: TextStyle(fontSize: 15, color: Colors.indigo.shade900, height: 0),
                                                                            ),
                                                                            subtitle: Text(
                                                                              'Work Experience',
                                                                              style: TextStyle(fontSize: 13, color: Colors.indigo.shade900, height: 0),
                                                                            )),
                                                                      ],
                                                                    )
                                                                  : Column(
                                                                      ...
                                                                      ? Column(
                                                                          children: [
                                                                            Container(
                                                                              width: 800,
                                                                              height: 50,
                                                                              decoration: const BoxDecoration(color: Color.fromARGB(255, 146, 176, 226), borderRadius: BorderRadius.only(topLeft: Radius.circular(5), topRight: Radius.circular(5))),
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  IconButton(
                                                                                    ...
                                                                                    onPressed: () {
                                                                                      setState(() {
                                                                                        expandCertificate = !expandCertificate;
                                                                                      });
                                                                                    },
                                                                                  ),
                                                                                ],
                                                                            ...
                                                                            ListTile(
                                                                                leading: CircleAvatar(backgroundColor: Colors.deepPurple.shade200),
                                                                                title: Text(
                                                                                  'Job Description',
                                                                                  style: TextStyle(fontSize: 15, color: Colors.indigo.shade900, height: 0),
                                                                                ),
